...
2. Неговите _**способности**_ или _поведение_: Това са _действията_, който може да извършва дадения обект. В ООП тези действия се представят чрез _**методите**_ (член-функциите) на класа. Имената на методите обикновено са _**глаголи**_.

3. Неговото текущо _**състояние**_: то се определя от текущите _**стойности**_ на полетата на обекта. Тези стойности могат - и често го правят - да модифицират поведението на дадения обект.
